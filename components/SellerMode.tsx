...
export default function SellerMode({
  ...
  // Prevent background scrolling while seller mode is open
  useEffect(() => {
    if (!open) return;
    ...
    const onKey = (e: KeyboardEvent) => {
      if (e.key === "Escape" && !newListingOpen) {
        onClose();
      }
    };
  ...
  useEffect(() => {
    ...
    getMyListings({ limit: 20 })
      .then((res) => {
        ...
        setMyListings(
          res.results.map(sellerListingToJet)
        );
      })
      .catch((err) => {
        if (cancelled) return;
  ...
  useEffect(() => {
    ...
    getCarousels()
      .then((data) => {
        ...
        setTrendingList(
          [...data.featured, ...data.verified].map(toJet)
        );
      })
  ...
  const activeListings = useMemo(
    () => myListings.filter(match).slice(0, 6),
    [myListings, term]
  );

  const filteredTrending = useMemo(
    () => trendingList.filter(match).slice(0, 8),
    [trendingList, term]
  );
  ...
  const content = (
    <div
      className={`seller-page ${open ? "open" : ""}`}
      id="sellerPage"
    >
      {/* =====================================================
          SELLER HEADER
          Same general structure as Header.tsx
      ====================================================== */}
      <header
        className={`navbar seller-navbar ${
          scrolled ? "scrolled" : ""
        }`}
        ref={headerRef}
      >
        ...
        {/* =====================================================
            ACTIONS
            Same direct navbar children as General Header
        ====================================================== */}
        ...
        {openPanel === "filter" && (
          <div className="drawer show">
            ...
            <p>
              Filtering for your listings and
              trending items — refine by keyword
        ...
        {openPanel === "notifications" && (
          <div className="drawer compact show">
            ...
            <p>
              Buyer inquiries, listing status
              changes, and platform updates will
              appear here.
            </p>
          </div>
        )}
      ...
      >
        <div className="container">
          ...
          <p>
            Manage your active listings, track
            buyer interest, and publish new assets.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="carousel-track">
            {myListingsLoading ? (
              ...
              >
                Log in as a seller to see your
                listings here.
              </p>
        ...
        <div className="container">
            ...
            <div className="footer-brand">
              ...
              >
                <img
                  src="/images/logo.png"
                  alt="M1 Marketplace"
                  className="brand-mark-img seller-footer-logo"
                />
          ...
          <div className="footer-newsletter">
            <div>
              ...
              <p>
                Curated listings, market intelligence,
                and off-market opportunities — delivered
                privately.
              </p>
            </div>
          ...
          <div className="footer-bottom">
            <span>
              © 2026 M1 Marketplace. All Rights Reserved.
            </span>
