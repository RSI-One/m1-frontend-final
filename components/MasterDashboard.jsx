...
import {
  ...
  complaintsActive, featuring, verifications, deals, m1wall, assetsDb
} from '@/lib/admin-data';
...
export default function MasterDashboard({ currentAdmin, onOpenModule, showToast }) {
