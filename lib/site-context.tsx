...
export function SiteProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo(
    () => ({ search, setSearch, maxBudget, setMaxBudget, showAllListings, toggleShowAllListings, toast, showToast }),
    [search, maxBudget, showAllListings, toggleShowAllListings, toast, showToast]
  );
