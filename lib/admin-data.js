...
export function pfp(seed, gender) { return `https://randomuser.me/api/portraits/${gender}/${seed}.jpg` }
export function esc(str) { return String(str).replace(/[&<>"']/g, (c) => ({ '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' }[c])) }
export function byId(id) { return typeof document !== 'undefined' ? document.getElementById(id) : null }
    ...
    export const jetImg = (i) => `https://images.unsplash.com/${['photo-1540962351504-03099e0a754b', 'photo-1474302770737-173ee21bab63', 'photo-1635672033263-a19f27eaefa8', 'photo-1619659085985-f51a00f0160a'][i % 4]}?w=600&h=400&fit=crop&auto=format`;
    ...
    export const supportLog = [
      { id: 's1', name: 'Tomasz Nowak', contact: '+48 601 222 111', date: 'Aug 8, 2026', help: 'Walked through verification document upload flow.' }
    ];
    export const ROLE_LABELS = { MASTER_ADMIN: 'Master Admin', GENERAL_ADMIN: 'General Admin', CUSTOMER_CARE_ADMIN: 'Customer Care Admin', BD_ADMIN: 'BD Admin', EXECUTIVE_ADMIN: 'Executive Admin', TECH_ADMIN: 'Tech Admin', FINANCE_ADMIN: 'Finance Admin', LISTING_ADMIN: 'Listing Admin', VERIFICATION_ADMIN: 'Verification Admin' };
